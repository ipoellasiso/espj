...
<head>
    ...
    <title>Sipapda - {{ $title }}</title>
    <link rel="shortcut icon" href="/app/assets/images/112a.png" type="image/x-icon">
    ...
    <style>
        ...
        .sp2d { top: 22%; right: 20%; }
        .kpp  { top: 44%; right: 35%; animation-delay: 1s; }
        .opd  { bottom: 22%; right: 18%; animation-delay: 2s; }
...
.doc {
    ...
    top: 30%;
    left: 15%;
    animation: floatSide 10s infinite alternate;
}
        ...
        <div class="row h-100">
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    ...
                    <h1 class="auth-title"><img src="/app/assets/images/edit2.png" style="width: 100%; height: 100%"  alt="Logo" srcset=""></h1>
                    {{-- <p class="auth-subtitle mb-5">Log in with your data that you entered during registration.</p> --}}
                    <br>
                    <form method="POST" class="my-login-validation" action="/cek_login">
                        @csrf
                        <div class="form-group position-relative has-icon-left mb-4">
                            <select type="text" class="form-select btn btn-outline-dark btn-block btn-lg sshadow-lg" name="tahun" id="tahun" placeholder="Tahun">
                    ...
                    <div class="text-center mt-5 text-lg fs-4">
                        ...
                        <p class="text-gray-600">Klik Tombol Home untuk kembali ke Halaman Depan <a href="/laporan/penerimaan" class="font-bold">Home</a>.</p>
            ...
            <div class="col-lg-7 d-none d-lg-block">
                <div id="auth-right">
                    <div class="sipapda-scene tax-animation">
                        ...
                        {{-- <div class="building">
                            ...
                            <div class="label">KANTOR PAJAK</div>
                        </div> --}}

                        <!-- Flow -->
                        {{-- <div class="flow sp2d"><span>SP2D</span></div> --}}
                        {{-- <div class="flow kpp"><span>KPP</span></div> --}}
                        {{-- <div class="flow opd"><span>OPD</span></div> --}}

                        <!-- Lines -->
                        {{-- <div class="line line-sp2d"></div> --}}
                        {{-- <div class="line line-kpp"></div> --}}

                        <div class="coin">Rp</div>
                        <div class="coin">Rp</div>
                        <div class="coin">Rp</div>
                        <div class="coin delay-1">Rp</div>
                        <div class="coin delay-2">Rp</div>
                        <div class="coin delay-3">Rp</div>
                        ...
                        {{-- <div class="branding">
                            <h2>SIPAPDA</h2>
                            <p>Sistem Informasi Pelaporan Pajak Daerah</p>
                        </div> --}}
